...
var TeacherRestController = function(TeacherModel) {
     ...
     * http://localhost:9016/api/v2/teachers     GET  - not implemented in app, just shown as example
     * 
     ...
     * http://localhost:9016/api/v1/teachers/5a1464bf3322b34128b20c8c           GET
     * http://localhost:9016/api/v1/teachers/:id                         GET
     * 
       curl  http://localhost:9016/api/v1/teachers/5a1464bf3322b34128b20c8c
       curl -i http://localhost:9016/api/v1/teachers/5a1464bf3322b34128b20c8c
       curl -i -X GET http://localhost:9016/api/v1/teachers/5a1464bf3322b34128b20c8c
       curl  http://localhost:9016/api/v1/teachers/5a1464bf3322b34128b20c8c
     * 
     * @param {*} req 
     * @param {*} res 
     ...
     * 
       curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": "0", "name":"ilker_0", "lastname":"kiris_0", "title":"teacher ", "age":200, "isFullTime":false}' http://localhost:9016/api/v1/teachers
       curl -X POST -H "Content-Type: application/json" -d     '{"teacherId": 1, "name":"ilker_1", "lastname":"kiris_1", "title":"teacher",  "age":201, "isFullTime":false}' http://localhost:9016/api/v1/teachers
       curl -X POST -H "Content-Type: application/json" --data '{"teacherId": 2, "name":"ilker_2", "lastname":"kiris_2", "title":" teacher", "age":202, "isFullTime":true}'  http://localhost:9016/api/v1/teachers
       curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 3, "name":"ilker_3", "lastname":"kiris_3", "title":" teacher", "age":203, "isFullTime":true}'  http://localhost:9016/api/v1/teachers
     * 
     ...
     * 
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 0, "name":"ilker_0_update",   "lastname":"kiris_0", "title":"teacher ", "age":200, "isFullTime":false}' http://localhost:9016/api/v1/teachers/5a23f72a1fb00a38f0a814a9
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 0, "name":"ilker_0_update_2", "lastname":"kiris_0", "title":"teacher ", "age":200, "isFullTime":false, "updatedOn":"2017-12-03T12:39:06.446Z"}' http://localhost:9016/api/v1/teachers/5a23f72a1fb00a38f0a814a9
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 0, "name":"ilker_0_update_2", "lastname":"kiris_0", "title":"teacher ", "age":200, "isFullTime":false, "updatedOn":"'"$(date +%Y-%m-%dT%H:%M:%S)"'"}' http://localhost:9016/api/v1/teachers/5a23f72a1fb00a38f0a814a9
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 3, "name":"ilker_3_update",   "lastname":"kiris_3", "title":"teacher ", "age":200, "isFullTime":false, "updatedOn":"'"$(date +%Y-%m-%dT%H:%M:%S)"'"}' http://localhost:9016/api/v1/teachers/5a2f2505c96a552334fdc762
     * 
     * In postman, select PUT as method, click Body, click raw, select "JSON(application/json)" pulldown,
     * in url enter   http://localhost:9016/api/v1/teachers/5a23e72b0a47f03f787cd618
     ...
     * 
       curl -X PATCH -H "Content-Type: application/json" -i -d '{"title":"sophomore", "age":123, "isFullTime":false}' http://localhost:9016/api/v1/teachers/5a23f72a1fb00a38f0a814a9
     * 
     * @param {*} req 
     * @param {*} res 
     */
     ...
     * 
       curl -X DELETE -i http://localhost:9016/api/v1/teachers/5a23f72a1fb00a38f0a814a9
     * 
     * @param {*} req 
     * @param {*} res 
     */
     ...
     * 
       curl -X DELETE -H "Content-Type: application/json" -i -d '{"_id":"5a2f1ef568f053451051ebdb"}' http://localhost:9016/api/v1/teachers
     * 
     * @param {*} req 
     * @param {*} res 
     */
